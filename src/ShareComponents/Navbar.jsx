        ...
        <div className="navbar-end space-x-3">
          <div>
            <label className="swap swap-rotate">
              ...
              {/* sun icon */}
              <svg
                className="swap-off fill-current w-10 h-10 text-[#0ecdb9]"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
              >
              ...
              {/* moon icon */}
              <svg
                className="swap-on fill-current w-10 h-10 text-[#0ecdb9]"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
              >
          ...
          {user ? (
            ...
            >
              ...
              {show && (
                <div className="absolute top-14 right-16 border-2 z-40 w-40 h-28 rounded-l-2xl rounded-b-2xl bg-[#1f2340] p-5 text-white ">
                  {isPosition === 'admin' && (
                  ...
                  {((isPosition !== 'admin' && isPosition !== 'host') ||
                    isPosition === 'user') && (
                    <NavLink to={'/dashboard/participate'}>Dashboard</NavLink>
                  )}

                  <button
                    onClick={handleOut}
                    className="btn bg-[#0ecdb9] border-none mt-2 text-white"
                  >
                    LogOut
                    <FaLongArrowAltRight />{' '}
                  </button>
            ...
            <Link to={'/login'}>
              <button className="btn bg-[#0ecdb9] border-none text-white">
