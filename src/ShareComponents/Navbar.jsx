...
const Navbar = () => {
  ...
  // ----------------- Role & Verified -----------------
  const [role] = useRole(); // admin/host/user
  const [isVerified] = useVerified(); // optional verified
            ...
            >
              ...
              {show && (
                <div className="absolute top-14 right-0 border-2 z-50 w-44 p-4 rounded-l-2xl rounded-b-2xl bg-[#1f2340] text-white flex flex-col gap-2">
                  ...
                  <button
                    onClick={handleOut}
                    className="btn bg-[#0ecdb9] border-none mt-2 text-white flex items-center justify-center gap-1"
                  >
