        ...
        <div className="hero-content  flex flex-col  md:flex-row-reverse">
          ...
          >
            ...
            <p className="py-6 text-left">
              ...
              can improve their talents by joining and competing in a wide range
              of contests.ContestHub is the go-to destination for anyone looking
              to sharpen their skills through different competitive
              challenges.ContestHub provides a platform where users can elevate
