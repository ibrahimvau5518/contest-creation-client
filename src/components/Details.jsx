        ...
        <div className="hero min-h-screen bg-[#1f2340] text-white">
          <div className="hero-content flex-col lg:flex-row justify-center items-center">
            ...
            <div>
              ...
              <p className="py-2">
                <span>Contest Prize</span>: {singleData?.prize}{' '}
                {typeof singleData.prize === 'number' && '$'}
              </p>
              <p className="py-2">
                <span>Contest Price</span>: {singleData?.price} $
              </p>
              ...
              {over && (
                <div className="flex justify-center flex-col items-center">
                  ...
                  <h2 className="mt-2">
                    Name: {singleData?.participateUserName}
                  </h2>
                </div>
              )}
                ...
                {over ? (
                  ...
                  <Link to={'/register'}>
                    <div
                      ...
                      className="badge badge-outline p-5 bg-[#0ecdb9] border-none"
                    >
                      Register Now
                    </div>
                  </Link>
