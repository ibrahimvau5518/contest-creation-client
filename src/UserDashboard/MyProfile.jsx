  ...
  return (
    <div>
      <div
        ...
        style={{
          backgroundImage:
            'url(https://egamlio.vercel.app/images/dashboard-banner-bg.png)',
        }}
      >
        <h1 className="text-4xl font-extrabold text-[#0ecdb9] p-8 ">
          Hi, Welcome Back
        </h1>
      </div>
      ...
      <div className="mt-5 grid grid-cols-1 md:grid-cols-2 justify-center items-center">
        <div>
          <div className="flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 bg-gray-900 dark:bg-[#212472] text-white dark:text-gray-800">
            <img
              src={Mydata.image || 'https://via.placeholder.com/150'}
              alt="Profile"
            ...
            <div className="space-y-4 text-center divide-y divide-gray-700 dark:divide-gray-300">
              <div className="my-2 space-y-1">
                <h2 className="text-xl font-semibold sm:text-2xl text-white capitalize">
                  {Mydata.name || 'Your Name'}
                </h2>
                <p className="px-5 text-xs sm:text-base text-white">
                  {Mydata.email || 'your.email@example.com'}
                </p>
                {Mydata.location && (
                  <p className="text-white">Location: {Mydata.location}</p>
                )}
              </div>
