...
const Update = () => {
  ...
  const onSubmit = async e => {
    ...
    axiosSecure
      .put(`/updateSingleData/${singleData?._id}`, info)
      .then(data => {
        if (data.data) {
          setLoading(false);
          Swal.fire('Updated');
  ...
  return (
    <div>
      ...
      <div>
        <form
          onSubmit={onSubmit}
          className="grid grid-cols-1 md:grid-cols-2 gap-6 border rounded-xl p-5"
        >
